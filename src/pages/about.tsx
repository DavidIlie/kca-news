                ...
                <div className="container mx-auto mt-10 max-w-7xl">
                    <Fade cascade triggerOnce duration={300}>
                        ...
                        <p className="text-justify">
                            ...
                            gravida. Donec libero ante, dapibus ut orci sit
                            amet, volutpat facilisis massa. Aenean sed nulla ac
                            nunc pharetra porttitor. Nullam viverra nibh lectus.
                        ...
                        <div className="justify-evenly gap-12 sm:flex">
                            <div>
                                ...
                                <p className="text-justify">
                                    ...
                                    Pellentesque nisl felis, suscipit id leo
                                    sed, accumsan accumsan mi. Mauris a lacus
                                    vehicula, ullamcorper odio ut, venenatis
                                    dolor. Vivamus vel nisi ex. Integer tempus
                                    turpis pellentesque nibh imperdiet, sed
                                ...
                                <div className="-mt-4 flex h-full items-center">
                                    <div className="container max-w-sm">
                                        <h1 className="mb-4 text-center font-medium">
                                            Want to help with writing articles,
                                            contribute new ideas or show off to
                                            other KCA students?
                                        </h1>
